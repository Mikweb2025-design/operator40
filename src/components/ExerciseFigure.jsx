...
import { INK, KHAKI, BLAZE } from '../constants/theme.js';
...
const floorLine = (x1, y, x2) => (
  <line x1={x1} y1={y} x2={x2} y2={y} stroke={KHAKI} strokeWidth="2" opacity="0.4" />
);
...
const groundShadow = (cx, y) => (
  <ellipse cx={cx} cy={y} rx="24" ry="4" fill={KHAKI} opacity="0.22" />
);

export function ExerciseFigure({ pose, color = BLAZE, size = '100%' }) {
      ...
      return wrap(
        ...
        <>
          ...
          <g id="figure">
            ...
            {dot(70, 82, 4.5)}
            <g id="dbArmL">
              <line x1="40" y1="82" x2="54" y2="60" {...limb} />
              {dot(54, 60)}
            </g>
            <g id="dbArmR">
              <line x1="58" y1="82" x2="76" y2="92" {...limb} />
              {dot(76, 92)}
            </g>
            <g id="dbLegL">
              <line x1="70" y1="82" x2="98" y2="88" {...limb} />
              {dot(98, 88)}
            </g>
            <g id="dbLegR">
              <line x1="70" y1="82" x2="88" y2="58" {...limb} />
              {dot(88, 58)}
            </g>
          </g>
        </>
      ...
      return wrap(
        ...
        <>
          ...
          <g id="figure">
            ...
            {dot(112, 76)}
            <g id="htL">
              <line x1="40" y1="82" x2="56" y2="80" {...limb} />
              {dot(56, 80)}
            </g>
            <g id="htR">
              <line x1="54" y1="82" x2="70" y2="80" {...limb} />
              {dot(70, 80)}
            </g>
          </g>
        </>
