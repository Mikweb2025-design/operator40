import { B as BLAZE, j as jsxRuntimeExports, K as KHAKI } from "./index-D0DDUjBy.js";
...
function ExerciseFigure({ pose, color = BLAZE, size = "100%" }) {
  const wrap = (viewBox, children) => /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { viewBox, width: size, height: size, className: `o40-figure pose-${pose}`, style: { color, overflow: "visible" }, children });
  switch (pose) {
    case "squat":
      return wrap("0 0 100 140", /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        floorLine(8, 134, 92),
        groundShadow(50, 133),
    ...
    case "plank":
      return wrap("0 0 160 100", /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        floorLine(10, 88, 150),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("g", { id: "figure", children: [
          head(136, 42, 9),
    ...
    case "superman":
      return wrap("0 0 160 90", /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        floorLine(10, 74, 150),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("g", { id: "figure", children: [
          head(132, 62, 9),
    ...
    case "russiantwist":
      return wrap("0 0 120 120", /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        floorLine(8, 108, 112),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("g", { id: "figure", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("g", { id: "upperTwist", children: [
            head(60, 44, 9),
