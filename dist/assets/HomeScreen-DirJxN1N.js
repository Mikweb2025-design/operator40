...
function getPersonalChallenge(sessions, profile) {
  ...
  if (n < 3) return { id: "first3", title: "Prime 3", desc: "Completa le prime 3 sessioni", target: 3, current: n, progress: n / 3, icon: "🌱", color: "#7FB069" };
  ...
  if (n < 10) return { id: "s10", title: "10 Sessioni", desc: "Raggiungi 10 allenamenti", target: 10, current: n, progress: n / 10, icon: "⚡", color: "#B8AE8C" };
  ...
  if (n < 25) return { id: "s25", title: "25 Sessioni", desc: "Costruisci abitudine", target: 25, current: n, progress: n / 25, icon: "🏆", color: "#C1440E" };
  return { id: "veterano", title: "Veterano", desc: "100 sessioni — leggenda", target: 100, current: n, progress: Math.min(1, n / 100), icon: "👑", color: "#B8AE8C" };
}
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "o40-tour-mask", onClick: onClose, style: { zIndex: 30 }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "o40-tour-card", onClick: (e) => e.stopPropagation(), style: { maxHeight: "90vh", overflowY: "auto", maxWidth: 520, width: "96vw", padding: 0, border: `1px solid ${OLIVE}`, borderRadius: 18, background: INK_2 }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: 16, display: "flex", flexDirection: "column", gap: 16 }, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { background: INK, border: `1px solid ${OLIVE}`, borderRadius: 12, padding: 12 }, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", gap: 6, overflowX: "auto" }, children: medals.all.slice(0, 8).map((m) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { minWidth: 56, textAlign: "center", opacity: m.unlocked ? 1 : 0.5 }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { width: 36, height: 36, borderRadius: "50%", margin: "0 auto", display: "grid", placeItems: "center", background: m.unlocked ? BLAZE : INK_2, border: `1px solid ${m.unlocked ? BLAZE : OLIVE}` }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Medal, { size: 14, color: m.unlocked ? PAPER : STEEL }) }),
...
function HomeScreen({ profile, sessions, customPrograms, waistHistory, weightHistory, onOpenProgram, onBuild, onEditCustom, onDeleteCustom, onDismissIntro, onPromote, onBellyTest, onPose }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "o40-screen-in", style: { flex: 1, display: "flex", flexDirection: "column" }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "o40-ticker o40-mono", style: { marginTop: 10, fontSize: 10.5, color: KHAKI, letterSpacing: "0.12em" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "o40-ticker-inner", children: [`${t("ticker.streak")} ${streak} ${t("dt.days").toUpperCase()}`, `${t("ticker.sessions")} ${sessions.length}`, `${t("ticker.kcal")} ${kcalWeek} / ${t("ticker.week7")}`, `${t("ticker.level")} ${tr(lvl.label, lang).toUpperCase()}`, `${t("ticker.mission")} ${todayProgram.id.toUpperCase()}`, `${t("ticker.goal")} ${sessionsThisWeek}/${weeklyGoal} ${t("ticker.week")}`, `${t("ticker.rank")} ${tr(rank.name, lang).toUpperCase()}`].concat(`${t("ticker.streak")} ${streak} ${t("dt.days").toUpperCase()}`, `${t("ticker.sessions")} ${sessions.length}`, `${t("ticker.kcal")} ${kcalWeek} / ${t("ticker.week7")}`, `${t("ticker.level")} ${tr(lvl.label, lang).toUpperCase()}`, `${t("ticker.mission")} ${todayProgram.id.toUpperCase()}`, `${t("ticker.goal")} ${sessionsThisWeek}/${weeklyGoal} ${t("ticker.week")}`, `${t("ticker.rank")} ${tr(rank.name, lang).toUpperCase()}`).map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: { display: "inline-flex", alignItems: "center", gap: 44 }, children: [
      s,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 10 }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "o40-card o40-ring-border o40-sheen", onClick: () => {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { position: "relative" }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "o40-embers", children: [["8%", "0s", "3.2s"], ["22%", "1.1s", "3.8s"], ["38%", "0.5s", "3.4s"], ["55%", "1.7s", "3.6s"], ["70%", "0.9s", "3.3s"], ["84%", "1.4s", "3.9s"], ["93%", "0.3s", "3.5s"]].map(([l, d, du], i) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "o40-ember", style: { left: l, animationDelay: d, animationDuration: du } }, i)) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center", gap: 8 }, children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "o40-mono", style: { color: KHAKI, fontSize: 9.5, letterSpacing: "0.08em", background: `${KHAKI}18`, border: `1px solid ${KHAKI}44`, borderRadius: 6, padding: "2px 7px" }, children: tr(todayProgram.focus, lang) }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { background: `linear-gradient(135deg, ${INK_2}, ${OLIVE_DARK})`, border: `1px solid ${OLIVE}`, borderRadius: 12, padding: "10px 12px", display: "flex", alignItems: "center", gap: 10 }, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { flex: 1, minWidth: 0 }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "o40-mono", style: { color: KHAKI, fontSize: 10, letterSpacing: "0.06em" }, children: t("home.dailyChallenge", { bonus: dailyChallenge.bonus }) }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => onOpenProgram(dailyChallenge.program), style: { background: BLAZE, color: PAPER, border: "none", borderRadius: 8, padding: "6px 12px", fontSize: 11, fontWeight: 700, cursor: "pointer", flexShrink: 0 }, children: t("home.daily.go") })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(CollapsibleSection, { id: "progressi", title: t("home.section.progress"), icon: TrendingUp, badge: `${cons}% · ${wp.done}/${wp.total} · ${streak}gg`, defaultOpen: showPinnedProgress, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(CollapsibleSection, { id: "missioni", title: t("home.section.missions"), icon: Target, badge: `${bellyProgress.done}/${bellyProgress.total} · ${customPrograms.length} custom`, defaultOpen: false, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { background: `linear-gradient(135deg, ${BLAZE}14, ${INK_2})`, border: `1px solid ${BLAZE}66`, borderRadius: 14, padding: 12, marginBottom: 12 }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center", gap: 8, marginBottom: 8 }, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { flex: 1 }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "o40-mono", style: { color: BLAZE, fontSize: 11, letterSpacing: "0.08em" }, children: t("home.belly.title") }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", gap: 8 }, children: getBellyMissions({ sessions, profile, waistHistory }).map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => onOpenProgram(p), style: {
          flex: 1,
          background: INK,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { color: PAPER, fontSize: 11, fontWeight: 700, lineHeight: 1.2, marginTop: 2 }, children: tr(p.name, lang) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", gap: 1, justifyContent: "center", marginTop: 4 }, children: Array.from({ length: 3 }).map((_, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { size: 8, color: i < (p.difficulty || 2) ? BLAZE : STEEL, fill: i < (p.difficulty || 2) ? BLAZE : "none" }, i)) }),
        ...
        (() => {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: 8, marginTop: 10 }, children: [
            ...
            next && /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: async () => {
              const p = { ...profile, bellyLevel: next, bellyLevelUpdated: (/* @__PURE__ */ new Date()).toISOString() };
              try {
      ...
      showOthers && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", flexDirection: "column", gap: 8, marginBottom: 12 }, children: others.map((p, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => onOpenProgram(p), style: {
        display: "flex",
        alignItems: "center",
        gap: 12,
        ...
        ["H", "I", "J", "K", "L", "M", "N", "O", "P"].includes(p.id) && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { position: "absolute", top: 6, right: 6, background: BLAZE, color: PAPER, fontSize: 8, fontWeight: 700, borderRadius: 4, padding: "1px 4px" }, children: "NEW" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { flex: 1 }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { color: PAPER, fontSize: 14.5, fontWeight: 600, display: "flex", alignItems: "center", gap: 6 }, children: [
            tr(p.name, lang),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { display: "flex", gap: 1 }, children: Array.from({ length: 3 }).map((_, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { size: 9, color: i < (p.difficulty || 2) ? KHAKI : STEEL, fill: i < (p.difficulty || 2) ? KHAKI : "none" }, i)) })
          ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 8 }, children: [
        customPrograms.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
          display: "flex",
          alignItems: "center",
          gap: 12,
          background: INK_2,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => onOpenProgram(p), style: { display: "flex", alignItems: "center", gap: 12, background: "transparent", border: "none", cursor: "pointer", textAlign: "left", flex: 1, padding: 0 }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { width: 40, height: 40, flexShrink: 0 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ExerciseFigure, { pose: EXERCISES[p.exercises[0]].pose, color: KHAKI }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { flex: 1 }, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => onEditCustom(p), style: { ...btnIcon, background: "transparent" }, "aria-label": "Modifica", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Settings, { size: 14, color: KHAKI }) }),
          ...
          }, style: { ...btnIcon, background: confirmDeleteId === p.id ? `${BLAZE}33` : "transparent" }, "aria-label": t("home.custom.delete"), children: confirmDeleteId === p.id ? /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { size: 16, color: BLAZE }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Trash2, { size: 16, color: STEEL }) })
        ] }, p.id)),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(CollapsibleSection, { id: "achievements", title: t("home.section.achievements"), icon: Medal, badge: `${unlockedAch}/${ach.length}`, defaultOpen: false, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(CollapsibleSection, { id: "misurazioni", title: t("home.section.measurements"), icon: Ruler, badge: waist || weight ? `${waist ? waist.cm + "cm" : ""}${waist && weight ? " · " : ""}${weight ? weight.kg + "kg" : ""}` : "—", defaultOpen: false, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 10 }, children: [
