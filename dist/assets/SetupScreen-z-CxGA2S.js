import { u as useT, g as getLevel, j as jsxRuntimeExports, L as LANGS, B as BLAZE, K as KHAKI, O as OLIVE, a as OLIVE_DARK, I as INK, b as INK_2, S as STEEL, i as inputStyle, T as TRACKS, P as PAPER, c as INTERVAL_PRESETS, d as LEVELS, t as tr, s as secondaryBtn, e as primaryBtnLarge, f as BLAZE_DEEP, h as isStandalonePWA } from "./index-D0DDUjBy.js";
import { V as Volume2, h as VolumeX, i as Vibrate, j as SkipForward, M as Music, k as Music2, l as HeadphoneOff, m as ChevronLeft, f as RefreshCw, n as Crown, o as Medal, D as Download, U as Upload, p as Bell, q as BellOff, s as Send, t as HeartPulse, b as ChevronRight } from "./icons-BHJLJdva.js";
...
function SetupScreen({ formName, setFormName, formAge, setFormAge, formWeight, setFormWeight, formWaist, setFormWaist, formHeight, setFormHeight, formCustomWork, setFormCustomWork, formCustomRest, setFormCustomRest, reminderHour, setReminderHour, reminderMinute, setReminderMinute, onSave, canCancel, onCancel, soundOn, onToggleSound, vibrationOn, onToggleVibration, musicOn, onToggleMusic, musicTrack, onSelectTrack, musicVolume, onChangeMusicVolume, musicAutoPlay, onToggleAutoPlay, musicShuffle, onToggleShuffle, onNextTrack, onPrevTrack, skipWarmup, onToggleSkipWarmup, voiceCountdown, onToggleVoiceCountdown, level, onSetLevel, intervalPreset, onSetIntervalPreset, executionMode, onSetExecutionMode, onImportHealth, healthImportStatus, healthWeightSuggestion, onApplyHealthWeight, showToast, largeText, setLargeText, pushEnabled, pushSupported, pushBusy, onTogglePush, onTestPush, onExportBackup, onImportBackup }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "o40-screen-in", style: { flex: 1, display: "flex", flexDirection: "column" }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "o40-scroll", style: { flex: 1, overflowY: "auto", padding: 20, display: "flex", flexDirection: "column", gap: 18 }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", gap: 8 }, children: LANGS.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setLang(l), style: {
        flex: 1,
        padding: "9px 0",
        borderRadius: 10,
        cursor: "pointer",
      ...
      }, children: l === "it" ? "ITALIANO" : l === "en" ? "ENGLISH" : "DEUTSCH" }, l)) }),
      ...
      canCancel && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { background: INK_2, border: `1px solid ${OLIVE}`, borderRadius: 14, padding: 14 }, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", flexDirection: "column", gap: 8 }, children: LEVELS.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => onSetLevel(l.key), style: {
          display: "flex",
          alignItems: "center",
          gap: 10,
          padding: "10px 12px",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "o40-mono", style: { color: curLevel.key === l.key ? BLAZE : KHAKI, fontSize: 11 }, children: [
            l.work,
            "″/",
            l.rest,
            "″"
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { background: INK_2, border: `1px solid ${OLIVE}`, borderRadius: 14, padding: 14 }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center", gap: 8, marginBottom: 6 }, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "o40-mono", style: { color: KHAKI, fontSize: 11, textTransform: "uppercase", letterSpacing: "0.08em", flex: 1 }, children: t("setup.backup.title") }),
