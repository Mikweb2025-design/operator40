import { j as jsxRuntimeExports, O as OLIVE, I as INK, K as KHAKI, B as BLAZE, S as STEEL, w as getRank, k as computeBestStreak, l as getConsistencyScore, q as getMedalProgress, C as getStreakRisk, u as useT, ad as LOCALES, ah as computeStreak, W as WEEKLY_GOAL, ai as buildHeatmap, aj as getPersonalRecords, ak as buildYearHeatmap, a as OLIVE_DARK, P as PAPER, b as INK_2, ag as RPE_COLORS, z as getWeeklyProgress, A as getAveragePace, ab as iconCircle, al as getMonthlyTrend, m as PROGRAMS, t as tr, ae as hrZone, af as RPE_LABELS, R as btnIcon, s as secondaryBtn, $ as primaryBtn, am as dayKey, an as sessionDayKey, ao as getNextMedals } from "./index-D0DDUjBy.js";
...
import { a as getSmartInsight, g as getGoalHistory, s as suggestNextGoal, c as getStreakWeeks, M as MiniGoalBar, f as formatGoal, e as estimateWeeklyCalories } from "./GoalRing-DKOjfX-p.js";
import { T as TopBar } from "./TopBar-CmsWR0tM.js";
...
function getDailyInsight({ sessions, profile, waistHistory, weightHistory, lang = "it" }) {
  ...
  if (n === 0) return { icon: "🌱", title: "Inizia", body: lang === "it" ? "Fai la prima sessione oggi — 15′ bastano." : "Do first session today — 15′ is enough.", color: "#7FB069", tip: lang === "it" ? "Scegli Assalto Pancia, ritmo dolce." : "Pick Belly Assault, easy pace." };
  ...
  return { icon: "💡", title: "Continua così", body: lang === "it" ? `Hai ${n} sessioni, streak ${computeBestStreak(sessions)} best. Mantieni ritmo.` : `You have ${n} sessions, best streak ${computeBestStreak(sessions)}. Keep rhythm.`, color: "#B8AE8C", tip: "Varia stimolo ogni 3-4 giorni." };
}
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 14 }, children: [
    [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "o40-mono", style: { color: STEEL, fontSize: 9, letterSpacing: "0.08em", marginBottom: 6, display: "flex", alignItems: "center", gap: 6 }, children: [
        cat.title,
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: { color: unlocked.filter((m) => m.type === cat.key).length ? "#7FB069" : STEEL, fontSize: 9 }, children: [
          unlocked.filter((m) => m.type === cat.key).length,
          "/",
          byType[cat.key].length
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", gap: 6, overflowX: "auto", paddingBottom: 4 }, children: byType[cat.key].map((m) => /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { label: m.label, value: m.n, unlocked: m.unlocked, color: m.color, icon: m.type === "streak" ? "fire" : m.type === "kcal" ? "target" : m.type === "perfect" ? "star" : "trophy", progress: m.progress }, `${m.type}-${m.n}`)) })
    ] }, cat.key)),
    next.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { background: `linear-gradient(135deg, ${OLIVE_DARK}, ${INK})`, border: `1px solid ${KHAKI}33`, borderRadius: 10, padding: "10px 12px", display: "flex", alignItems: "center", gap: 8 }, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: { color: KHAKI, fontSize: 11, flex: 1 }, children: [
        "Prossime: ",
        next.map((m) => `${m.icon} ${m.n}${m.type === "kcal" ? "" : m.type === "streak" ? "gg" : ""} (${Math.round(m.progress * 100)}%)`).join(" • ")
      ] })
    ] })
  ] });
}
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "o40-scroll", style: { flex: 1, overflowY: "auto", padding: 16 }, children: [
      ...
      (() => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: 20 }, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { background: INK_2, border: `1px solid ${OLIVE}`, borderRadius: 14, padding: "12px 10px" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", alignItems: "flex-end", gap: 6, height: 80 }, children: months.map((m) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { flex: 1, display: "flex", flexDirection: "column", alignItems: "center", gap: 4 }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { width: "100%", height: `${Math.round(m.kcal / maxK * 60) + 4}px`, background: m.kcal ? BLAZE : OLIVE_DARK, borderRadius: 3, opacity: m.kcal ? 1 : 0.5 } }),
      ...
      sessions.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: 20 }, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { background: INK_2, border: `1px solid ${OLIVE}`, borderRadius: 14, padding: 14, display: "flex", flexDirection: "column", gap: 10 }, children: PROGRAMS.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { height: 6, borderRadius: 3, background: OLIVE_DARK, overflow: "hidden" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { height: "100%", width: `${counts[p.id] / maxCount * 100}%`, background: BLAZE, borderRadius: 3, transition: "width 0.4s ease" } }) })
        ] }, p.id)) })
      ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", flexDirection: "column", gap: 8 }, children: ordered.map((s, i) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 6, background: INK_2, border: `1px solid ${OLIVE}`, borderRadius: 14, padding: 12 }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center", gap: 10 }, children: [
            ...
            s.rpe && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "o40-mono", style: { color: STEEL, fontSize: 10.5, border: `1px solid ${OLIVE}`, borderRadius: 4, padding: "2px 5px" }, children: tr(RPE_LABELS[s.rpe - 1], lang) }),
