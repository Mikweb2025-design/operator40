...
import { u as useT, X as levelPreset, Y as estimateProgramKcal, Z as totalSeqSeconds, j as jsxRuntimeExports, P as PAPER, t as tr, K as KHAKI, B as BLAZE, U as EXERCISE_GROUPS, O as OLIVE, b as INK_2, I as INK, J as EXERCISES, S as STEEL, a0 as getReps, a1 as HOLD_EXERCISES, V as speak, R as btnIcon, a as OLIVE_DARK, $ as primaryBtn, _ as __vitePreload } from "./index-D0DDUjBy.js";
import { r as reactExports, W as Wind, f as RefreshCw, J as Play } from "./icons-BHJLJdva.js";
...
function PreviewScreen({ program, profile, soundOn, onBack, onStart }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "o40-screen-in", style: { flex: 1, display: "flex", flexDirection: "column" }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "o40-scroll", style: { flex: 1, overflowY: "auto", padding: 16 }, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "o40-mono", style: { color: KHAKI, fontSize: 11, textTransform: "uppercase", letterSpacing: "0.08em", margin: "4px 0 10px" }, children: t("prev.sub", { n: program.exercises.length, r: program.rounds, p: mode === "reps" ? lang === "it" ? "Ripetizioni" : lang === "de" ? "Wiederholungen" : "Reps" : tr(preset.label, lang) }) }),
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: 12 }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { flex: 1, minWidth: 0 }, children: [
                ...
                isOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", flexDirection: "column", gap: 3, marginTop: 5, textAlign: "left" }, children: ex.steps.map((s, k) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: 6, alignItems: "flex-start" }, children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { color: STEEL, fontSize: 11.5, marginTop: 3, lineHeight: 1.4, fontStyle: "italic" }, children: tr(ex.tip40, lang) })
              ] })
            ] }),
          ...
          isSwapping && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", flexWrap: "wrap", gap: 6, paddingTop: 4, borderTop: `1px solid ${OLIVE_DARK}` }, children: [
            ...
            alternatives.map((aid) => /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => {
              ...
              cursor: "pointer"
            }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "o40-mono", style: { color: PAPER, fontSize: 10.5 }, children: tr(EXERCISES[aid].name, lang) }) }, aid))
          ] })
        ] }, originalId);
      }) })
    ] }),
